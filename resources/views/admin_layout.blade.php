    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="{{asset('public/frontend/images/avatar.jpg')}}">
                <span class="username">
                	<?php
...
$(document).ready(function(){
  ...
  resize: true,
  colors: [
    '#FF6347',   // Màu đỏ tươi cho "Sản phẩm"
    '#4CAF50',   // Màu xanh lá cho "Đơn Hàng"
    '#FFD700',   // Màu vàng cho "Người dùng"
    '#20B2AA',   // Màu xanh biển nhẹ cho các phần còn lại (nếu có)
    '#FF4500'    // Màu cam cho các phần bổ sung
  ],
  
  data: [
    { label: 'Sản phẩm', value: 15  },
    { label: 'Đơn Hàng', value: 5 },
