...
<div class="table-agile-info">
  ...
  <div class="panel panel-default">
    <div class="panel-heading" style="font-size: 16px; font-weight: bold; background-color: #FE980F; color: white; padding: 8px;">
      Xem đơn hàng đã đặt
    </div>
    ...
    <div class="table-responsive" style="padding: 10px;">
      <?php
        ...
        if($message){
            echo '<span class="text-alert" style="font-size: 14px; color: red;">'.$message.'</span>';
            Session::put('message',null);
        }
      ?>
      <table class="table table-striped b-t b-light" style="font-size: 14px; width: 100%; margin-bottom: 10px;">
        <thead>
          <tr>
  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive" style="padding: 10px;">
      ...
      <table class="table table-striped b-t b-light" style="font-size: 14px; width: 100%; margin-bottom: 10px;">
        <thead>
          <tr>
            <th style="width:5%; font-size: 14px;">
