...
class HomeController extends Controller
{
    public function send_mail(){
         //send mail
                $to_name = "Sa nguyen";
                $to_email = "nguyenvansa2504@gmail.com";//send to this email
    ...
    public function index(Request $request){
        ...
        //seo 
        $meta_desc = "Chuyên bán điện thoại , điện thoại cũ, phụ kiện , thiết bị công nghệ"; 
        $meta_keywords = "điện thoại smartphone";
        $meta_title = "phụ kiện điện thoại, loptop";
        ...
        $all_product = DB::table('tbl_product')->where('product_status','0')->orderby(DB::raw('RAND()'))->paginate(3); 
